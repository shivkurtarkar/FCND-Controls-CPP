...
![overall picture](./misc/controller.png)

## Implement calculating the motor commands given commanded thrust and moments in C++.

![image eq of force on each motor to cumulative force and moment](./misc/forces_eq.png)

From Collective thrust and rotational moments we calculate individual rotor thrust based on the above equation.
F1: front left, F2: front right, F3: rear left, F4: rear right
M is moment
...
![roll picth controller](./misc/roll_pitch_controller.png)
...
![altitude controller](./misc/altitude_controller.png)
